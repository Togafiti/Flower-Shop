    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (!pass.equals(cpass)) {
                ...
                int id = d.getUserUsername(user).getId();
                String name = d.getUserUsername(user).getName();
                String email = d.getUserUsername(user).getEmail();
                String phone = d.getUserUsername(user).getPhone();
                Date created = d.getUserUsername(user).getCreated();
                Users unew = new Users(id, name, email, phone, user, cpass, created);
                d.updatePass(unew);
            }
        } catch (Exception e) {
        }
