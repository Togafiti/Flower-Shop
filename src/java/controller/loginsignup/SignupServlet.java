...
public class SignupServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //check ton tai
        DAO cdb = new DAO();
        Users u = cdb.getUserUsername(user);
        if (u != null) {
            String error = "username da ton tai";
            ...
            if (!pass.equals(cpass)) {
                ...
                Users cNew = new Users(id, uname, email, phone, user, pass, created);
                cdb.insert(cNew);
                request.setAttribute("error", "successful registration");
                request.getRequestDispatcher("signup.jsp").forward(request, response);
            }
        }
    }
